...
class LevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create level" do
    assert_difference("Level.count") do
      post levels_url, params: { level: { equipable_id: @level.equipable_id, grade_number: @level.grade_number } }
    end
  ...
  test "should update level" do
    patch level_url(@level), params: { level: { equipable_id: @level.equipable_id, grade_number: @level.grade_number } }
