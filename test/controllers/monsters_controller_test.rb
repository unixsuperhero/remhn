...
class MonstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create monster" do
    assert_difference("Monster.count") do
      post monsters_url, params: { monster: { key: @monster.key, name: @monster.name, size: @monster.size } }
    end
  ...
  test "should update monster" do
    patch monster_url(@monster), params: { monster: { key: @monster.key, name: @monster.name, size: @monster.size } }
