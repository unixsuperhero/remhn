...
class StarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create star" do
    assert_difference("Star.count") do
      post stars_url, params: { star: { hp: @star.hp, monster_id: @star.monster_id, raid_hp: @star.raid_hp, stars: @star.stars } }
    end
  ...
  test "should update star" do
    patch star_url(@star), params: { star: { hp: @star.hp, monster_id: @star.monster_id, raid_hp: @star.raid_hp, stars: @star.stars } }
